...
// Source: plan_data.py via generate_kotlin.py
...
object PlanData {
  ...
  val weeks: List<WeekPlan> = listOf(
    WeekPlan(1, 1, "Base & Foundation", 16, 6, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 5, 10), "Run", "6.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 6, 78, 889)
    ), WeekCalories(1, 1, 250.0, 2135, 640, 3642, 520, 3295, 500, 2795, 225, 88)),
    WeekPlan(2, 1, "Base & Foundation", 18, 7, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 5, 17), "Run", "7.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 7, 91, 1037)
    ), WeekCalories(2, 1, 248.8, 2129, 638, 4030, 576, 3343, 500, 2843, 224, 87)),
    WeekPlan(3, 1, "Base & Foundation", 20, 8, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 5, 24), "Run", "8.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 8, 104, 1185)
    ), WeekCalories(3, 1, 247.6, 2124, 637, 4086, 584, 3345, 500, 2845, 223, 87)),
    WeekPlan(4, 1, "Base & Foundation", 18, 7, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 5, 31), "Run", "7.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 7, 91, 1037)
    ), WeekCalories(4, 1, 246.4, 2118, 635, 4030, 576, 3329, 500, 2829, 222, 86)),
    WeekPlan(5, 1, "Base & Foundation", 22, 9, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 6, 7), "Run", "9.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 9, 117, 1333)
    ), WeekCalories(5, 1, 245.2, 2113, 633, 4308, 615, 3361, 500, 2861, 221, 86)),
    WeekPlan(6, 1, "Base & Foundation", 20, 8, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 6, 14), "Run", "8.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 8, 104, 1185)
    ), WeekCalories(6, 1, 244.0, 2107, 632, 4252, 607, 3346, 500, 2846, 220, 85)),
    WeekPlan(7, 2, "Aerobic Development", 24, 9, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 6, 21), "Run", "9.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 9, 117, 1296)
    ), WeekCalories(7, 2, 242.9, 2102, 630, 4692, 670, 3402, 500, 2902, 219, 85)),
    WeekPlan(8, 2, "Aerobic Development", 26, 10, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 6, 28), "Run", "10.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 10, 130, 1440)
    ), WeekCalories(8, 2, 241.7, 2097, 629, 5084, 726, 3452, 500, 2952, 218, 85)),
    WeekPlan(9, 2, "Aerobic Development", 28, 11, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 7, 5), "Run", "11.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 11, 143, 1584)
    ), WeekCalories(9, 2, 240.5, 2092, 627, 5180, 740, 3459, 500, 2959, 216, 84)),
    WeekPlan(10, 2, "Aerobic Development", 24, 9, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 7, 12), "Run", "9.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 9, 117, 1296)
    ), WeekCalories(10, 2, 239.3, 2086, 625, 4854, 693, 3404, 500, 2904, 215, 84)),
    WeekPlan(11, 2, "Aerobic Development", 30, 12, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 7, 19), "Run", "12.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 12, 156, 1728)
    ), WeekCalories(11, 2, 238.1, 2081, 624, 5484, 783, 3488, 500, 2988, 214, 83)),
    WeekPlan(12, 2, "Aerobic Development", 32, 13, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 7, 26), "Run", "13.0 mi — Long run w/ finish surge: easy 11.0 mi @ Z2 / final 2 mi steady Z3 high. Practice fueling.", "Z2 (Z3 only on prescribed segments)", 13, 169, 1872)
    ), WeekCalories(12, 2, 236.9, 2075, 622, 5876, 839, 3536, 500, 3036, 213, 83)),
    WeekPlan(13, 2, "Aerobic Development", 28, 11, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 8, 2), "Run", "11.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 11, 143, 1584)
    ), WeekCalories(13, 2, 235.7, 2070, 621, 5252, 750, 3441, 500, 2941, 212, 82)),
    WeekPlan(14, 2, "Aerobic Development", 32, 13, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 8, 9), "Run", "13.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 13, 169, 1872)
    ), WeekCalories(14, 2, 234.5, 2064, 619, 5876, 839, 3522, 500, 3022, 211, 82)),
    WeekPlan(15, 3, "Threshold & Race-Specific", 34, 13, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 8, 16), "Run", "13.0 mi — Long run w/ finish surge: easy 11.0 mi @ Z2 / final 2 mi steady Z3 high. Practice fueling.", "Z2 (Z3 only on prescribed segments)", 13, 169, 1794)
    ), WeekCalories(15, 3, 233.3, 2059, 617, 5589, 798, 3474, 350, 3124, 210, 82)),
    WeekPlan(16, 3, "Threshold & Race-Specific", 36, 14, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 8, 23), "Run", "14.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 14, 182, 1932)
    ), WeekCalories(16, 3, 232.1, 2053, 615, 5981, 854, 3522, 350, 3172, 209, 81)),
    WeekPlan(17, 3, "Threshold & Race-Specific", 32, 12, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 8, 30), "Run", "12.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 12, 156, 1656)
    ), WeekCalories(17, 3, 231.0, 2048, 614, 5367, 767, 3429, 350, 3079, 208, 81)),
    WeekPlan(18, 3, "Threshold & Race-Specific", 38, 14, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 9, 6), "Run", "14.0 mi — Long run w/ HMP segment: 4 mi Z2 / 4 mi @ goal HMP / remainder Z2. Practice fueling.", "Z2 (Z3 only on prescribed segments)", 14, 182, 1932)
    ), WeekCalories(18, 3, 229.8, 2043, 612, 6175, 882, 3537, 350, 3187, 207, 80)),
    WeekPlan(19, 3, "Threshold & Race-Specific", 40, 15, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 9, 13), "Run", "15.0 mi — Long run w/ HMP segment: 4 mi Z2 / 4 mi @ goal HMP / remainder Z2. Practice fueling.", "Z2 (Z3 only on prescribed segments)", 15, 195, 2070)
    ), WeekCalories(19, 3, 228.6, 2038, 611, 6223, 889, 3538, 350, 3188, 206, 80)),
    WeekPlan(20, 3, "Threshold & Race-Specific", 35, 12, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 9, 20), "Run", "12.0 mi — Long run w/ HMP segment: 4 mi Z2 / 4 mi @ goal HMP / remainder Z2. Practice fueling.", "Z2 (Z3 only on prescribed segments)", 12, 156, 1656)
    ), WeekCalories(20, 3, 227.4, 2032, 609, 5815, 831, 3472, 350, 3122, 205, 80)),
    WeekPlan(21, 3, "Threshold & Race-Specific", 40, 14, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 9, 27), "Run", "14.0 mi — Long run w/ HMP segment: 4 mi Z2 / 4 mi @ goal HMP / remainder Z2. Practice fueling.", "Z2 (Z3 only on prescribed segments)", 14, 182, 1932)
    ), WeekCalories(21, 3, 226.2, 2027, 608, 6195, 885, 3520, 350, 3170, 204, 79)),
    WeekPlan(22, 3, "Threshold & Race-Specific", 36, 13, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 10, 4), "Run", "13.0 mi — Long run w/ HMP segment: 4 mi Z2 / 4 mi @ goal HMP / remainder Z2. Practice fueling.", "Z2 (Z3 only on prescribed segments)", 13, 169, 1794)
    ), WeekCalories(22, 3, 225.0, 2021, 606, 5953, 850, 3477, 350, 3127, 202, 79)),
    WeekPlan(23, 4, "Sharpen & Taper", 34, 14, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 10, 11), "Run", "14.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 14, 182, 1890)
    ), WeekCalories(23, 4, 225, 2021, 606, 5284, 755, 3382, 0, 3382, 202, 79)),
    WeekPlan(24, 4, "Sharpen & Taper", 32, 12, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 10, 18), "Run", "12.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 12, 156, 1620)
    ), WeekCalories(24, 4, 225, 2021, 606, 5132, 733, 3360, 0, 3360, 202, 79)),
    WeekPlan(25, 4, "Sharpen & Taper", 28, 10, listOf(
      ...
      DayPlan("Sun", LocalDate.of(2026, 10, 25), "Run", "10.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 10, 130, 1350)
    ), WeekCalories(25, 4, 225, 2021, 606, 4556, 651, 3278, 0, 3278, 202, 79)),
    WeekPlan(26, 4, "Sharpen & Taper", 22, 8, listOf(
      ...
      DayPlan("Tue", LocalDate.of(2026, 10, 27), "Run", "5.0 mi — Tempo: 1.5 mi WU / 3x6min Z4 (2 min jog) / 1 mi CD — sharpener", "Z2 -> Z4 -> Z2", 5, 65, 675),
      ...
      DayPlan("Thu", LocalDate.of(2026, 10, 29), "Run", "4.0 mi — Easy aerobic", "Z2", 4, 52, 540),
      DayPlan("Fri", LocalDate.of(2026, 10, 30), "Rest", "REST DAY", "—", 0.0, 0, 0),
      DayPlan("Sat", LocalDate.of(2026, 10, 31), "Run", "3.0 mi — Easy + 4x20s strides", "Z2 + brief Z5", 3, 39, 405),
      DayPlan("Sun", LocalDate.of(2026, 11, 1), "Run", "8.0 mi — Long run, conversational pace. Practice fueling (gel every 30-40 min).", "Z2 (Z3 only on prescribed segments)", 8, 104, 1080)
    ), WeekCalories(26, 4, 225, 2021, 606, 3819, 546, 3173, 0, 3173, 202, 79)),
    ...
    ), WeekCalories(27, 4, 225, 2021, 606, 3300, 471, 3098, 0, 3098, 202, 79)),
  )
}
